...
/**
 * Implémentation Java en un seul fichier des scripts ex1.sh, ex2.sh, et
 * codage_decodage.sh,
 * en utilisant des 'long' 64 bits et sans BigInteger,
 * conformément à la logique des scripts originaux.
 *
 * ATTENTION :
 * Tout comme dans les scripts Bash, cette implémentation souffrira de
 * dépassements de capacité (integer overflow) si les nombres (p, q, n, etc.)
 * deviennent trop grands pour être stockés dans un 'long' 64 bits.
 * Les fonctions expoModulaire, clePublique, etc., sont particulièrement
 * sensibles.
 */
public class RSA {

    // L'équivalent de la variable $RANDOM, partagé par toutes les fonctions
    ...
    // ===================================================================
    // FONCTION PRINCIPALE (MAIN) DE CODAGE_DECODAGE.SH
    // ===================================================================
