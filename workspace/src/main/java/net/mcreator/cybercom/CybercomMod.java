...
public class CybercomMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(CybercomMod.class);
	public static final String MODID = "cybercom";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing CybercomMod");
		tick();
